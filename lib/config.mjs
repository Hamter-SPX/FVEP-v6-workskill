    ...
    mobile: {
      ...
      cases: Array.isArray(source.mobile?.cases)
        ? source.mobile.cases.map((c) => ({
            ...
            // Subset of mobile.devices keys this case runs on; absent or null
            // means "every device". Unknown keys are rejected in
            // validateConfig (device matrix guards below).
            devices: Array.isArray(c.devices) ? c.devices.map(String) : null,
