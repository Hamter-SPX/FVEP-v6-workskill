...
export function auditSkillConformance(input = {}, policy = {}) {
  ...
  if (packageJson.name !== 'fullstack-vision-engineering-pro' || packageJson.version !== '6.0.0') findings.push(processFinding('PACKAGE_IDENTITY_INVALID', 'blocker', 'Package name and version must identify Full-Stack Vision Engineering Pro v6.0.0.'));
