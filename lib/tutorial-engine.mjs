...
export function runStep(step, { toyDir = TOY_DIR, exec = defaultExec, variant, timeoutMs = DEFAULT_TIMEOUT_MS } = {}) {
  if (!step || !step.run) {
...
export function prepareToyRun(srcToyDir = TOY_DIR, { baseDir = '/tmp' } = {}) {
