...
export async function writeRunSummary(config, sections, options = {}) {
  ...
  // as before. Mobile (ios-sim|android) runs cannot produce web runtime
  // evidence, so that gate drops out; the loop's mobile branch runs compare by
  // default, and a present sections.comparison re-applies the visual gate.
