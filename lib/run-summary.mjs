...
function summarizeSections(sections) {
  ...
  return { capture, inspection, accessibility, interaction, stateCrawler, performance, engineering, comparison, tokens, breakpoints, baseline, manualReview, aesthetics };
}
